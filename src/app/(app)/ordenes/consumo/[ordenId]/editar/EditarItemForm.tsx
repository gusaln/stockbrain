...
import { Almacen, OrdenConsumoItem, Producto } from "@/lib/queries/shared";
import { useState } from "react";
import { useFormState } from "react-dom";
import { ToastContainer } from "react-toastify";
import { bindBorrarOrdenConsumoItem, bindEditarOrdenConsumoItem } from "./page";

const initialState = newInitialState();

interface Props {
    item: OrdenConsumoItem;
    almacenes: Almacen[];
    productos: Producto[];
    onEditar: ReturnType<typeof bindEditarOrdenConsumoItem>;
    onBorrar: ReturnType<typeof bindBorrarOrdenConsumoItem>;
}
